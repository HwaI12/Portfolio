...
const MoneyRecords = () => {
  ...
  const githubUrl = "https://github.com/HwaI12/monthly-hackathon-23-vol5";
  ...
  return (
    <div className={`container text-center ${fadeIn ? "fade-in" : ""}`}>
      <section className='Top'>
        <h2 className={`text-uppercase ${fadeIn ? "fade-in" : ""}`}>MONEY RECORDS</h2>
        <div className={`g-slide ${fadeIn ? "fade-in" : ""}`} style={{ maxWidth: "960px", width: "100%", margin: "20px auto" }}>
          <div style={{ position: "relative", paddingBottom: "56.25%", width: "100%", height: 0 }}>
            <iframe
              ...
              src="https://docs.google.com/presentation/d/e/2PACX-1vT1cPfcdPs53kN4wG9Dp0yAfx3mVbGXwIQWY3HcHUr_5yFSRzVH3pGKM3a-ej3FC5PHpKGic_GoKZm-/embed?start=false&loop=false&delayms=3000"
